test_that("Addin errors if required environment variables not set", {
  withr::with_envvar(
    new = c("SHINYSENDER_USER" = "alice", "SHINYSENDER_SERVER" = ""),
    {
      expect_error(
        ss_uploadAddin(),
  ...
  withr::with_envvar(
    new = c("SHINYSENDER_USER" = "", "SHINYSENDER_SERVER" = "myserver"),
    {
      expect_error(
        ss_uploadAddin(),
  ...
  # In either order
  withr::with_envvar(
    new = c("SHINYSENDER_USER" = "", "SHINYSENDER_SERVER" = ""),
    {
      expect_error(
        ss_uploadAddin(),
        "(SHINYSENDER_USER.+SHINYSENDER_SERVER|SHINYSENDER_SERVER.+SHINYSENDER_USER)"
      )
    }
  )
})
