test_that("Can get application listing", {
  ...
  lsShinyApps <- list(status = 0L, stdout = as.raw(
    c(
      0x6c, 0x6f, 0x67, 0x0a, 0x6d,
      ...
      0x73, 0x74, 0x61, 0x70, 0x70, 0x32, 0x0a
    )), stderr = raw(0))
  ...
  expect_equal(
    ss_listdir(fakesession),
    c("log", "mindthegap", "prototypingworkshop", "proxytest", "shinydemorob", "testapp2")
  )
})
